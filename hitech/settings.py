"""
Django settings for hitech project.
...
SECRET_KEY = 'django-insecure-k656u&fyanlhabztr@v0pws@edyny$p!)bj-6*z@inoox&kbdj'
...
WSGI_APPLICATION = 'hitech.wsgi.application'
