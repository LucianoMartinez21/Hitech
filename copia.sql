...
-- Volcando datos para la tabla django.auth_permission: ~24 rows (aproximadamente)
...
-- Volcando datos para la tabla django.django_content_type: ~6 rows (aproximadamente)
...
-- Volcando datos para la tabla django.django_migrations: ~5 rows (aproximadamente)
...
-- Volcando datos para la tabla django.django_session: ~0 rows (aproximadamente)
